...
const { updateProfileImg } = require('../utils/multer')
...
router.route('/me/profile-img')
    .post(passport.authenticate('jwt', {session: false}), updateProfileImg().single('profile-img'), userServices.postProfileImg)
    //.get()
